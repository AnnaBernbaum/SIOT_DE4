...
rcloneName="annabox"     # Name of Remote Storage Service
syncRoot="/home/pi"      # Root Folder to Start
localDir="/home/pi/Documents/SIOT/Live/Data"      # Source Folder on Local
remoteDir="SIOT"     # Destination Folder on Remote
