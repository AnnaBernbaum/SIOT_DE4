...
def get_sentiment(data):
    ...
    dates_to_add = pd.date_range(start='2018-12-22 14:00:00', end='2018-12-23 10:00:00', freq='H')
    ...
    dates_to_add = pd.date_range(start='2018-12-31 13:00:00', end='2019-01-01 12:00:00', freq='H')
    length = len(dates_to_add)
    senti = np.empty(length)
    senti[:] = np.nan
    to_add = {'datetime':dates_to_add, 'sentiment': senti, 'text':senti}
